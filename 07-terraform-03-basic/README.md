...
## Ответ
```
 ras@ras-VirtualBox  ~/DevOps/07-terraform-03-basic   main ±  terraform workspace list
  default
* prod
  stage
...
```
```
 ras@ras-VirtualBox  ~/DevOps/07-terraform-03-basic   main ±  terraform plan -var="yandex-token=AQAAAAB111111" -var="yandex-cloud-id=1111111117iq2j" -var="yandex-folder-id=111111111v2691p08"
