...
## Ответ
В конечной версии плейбука установка происходит из локального архива, т.к. на момент выполнения работы не было доступа к официальным дистрибам с сайта elastic, даже из  ip адресов США, Франции, Нидерландов и Японии. 
```
name: Install Kibana
  hosts: kibana
  tasks:
